...
const HELP =
  "ℹ️ Откройте /start, выберите видео и нажмите «Купить». Оплата проходит через Telegram Stars, а файл приходит сразу после оплаты.\n\n" +
  "Нужна помощь? Откройте раздел поддержки в каталоге.";

const backToMenu = inlineKeyboard([[inlineButton("⬅️ В каталог", "menu:main")]]);
